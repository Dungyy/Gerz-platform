...
export default function Sidebar({ profile, currentPath }) {
  ...
  return (
    <>
      {/* Mobile menu button */}
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur border-b px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-b bg-muted/30">
            <div className="flex items-center gap-3">
              <div className="grid h-10 w-10 place-items-center rounded-full bg-foreground text-background font-semibold">
          ...
          <div className="p-4 border-t">
            <button
              ...
              className="flex items-center gap-3 px-3 py-2 w-full text-left text-muted-foreground hover:bg-muted hover:text-foreground rounded-lg transition-colors text-sm"
            >
