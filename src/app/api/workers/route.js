...
export async function POST(request) {
  try {
    ...
    if (phone && send_sms) {
      try {
        const smsMessage = `Welcome to ${managerProfile.organization.name} maintenance team! You've been added as a worker. Check your email (${email}) to set your password and access the system. - Gerz`
