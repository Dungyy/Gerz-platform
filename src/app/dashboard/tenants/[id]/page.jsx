...
export default function TenantDetailPage() {
  ...
  async function handleRemoveTenant() {
    if (!confirm('Are you sure you want to remove this tenant? This will unassign them from their unit but keep their account active.')) {
      return
    }
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex gap-2">
          ...
          <Button variant="outline" className="text-red-600" onClick={handleRemoveTenant}>
              ...
              {tenant.email && (
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${tenant.email}`} className="font-medium hover:text-blue-600">
                      {tenant.email}
                    </a>
                  </div>
                </div>
              ...
              {tenant.phone && (
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <a href={`tel:${tenant.phone}`} className="font-medium hover:text-blue-600">
                      {tenant.phone}
                    </a>
                  </div>
                </div>
              ...
              <CardContent className="space-y-4">
                ...
                {unit.square_feet && (
                  <div>
                    ...
                    <p className="font-medium">{unit.square_feet.toLocaleString()} sq ft</p>
                  </div>
                )}

                <div className="pt-4 border-t">
                  <p className="text-sm text-gray-600 mb-2">Property</p>
                  <Link href={`/dashboard/properties/${property.id}`} className="hover:text-blue-600">
            ...
            <Card className="border-orange-200 bg-orange-50">
              <CardContent className="pt-6">
                <div className="text-center">
                  ...
                  <h3 className="font-semibold text-orange-900 mb-2">No Unit Assigned</h3>
