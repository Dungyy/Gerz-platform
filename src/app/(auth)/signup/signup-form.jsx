...
export default function SignupForm() {
  ...
  async function verifyInvitation(token) {
    ...
    try {
      ...
      toast.success("Invitation verified! Complete your profile to get started.");
    } catch (error) {
        ...
        <Card className="shadow-lg border-border/50">
          <CardHeader className="text-center space-y-3 pb-6">
            {invitationData ? (
              <>
                ...
                <div className="p-3 sm:p-4 rounded-lg bg-blue-500/5 border border-blue-500/20">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Organization Name (only for owners) */}
              {!invitationData && (
                <div className="space-y-2">
                  <label
                  ...
                  <p className="text-xs text-muted-foreground">
                    A unique organization code will be generated automatically
                  </p>
                </div>
              )}
              ...
              <div className="p-3 rounded-lg border bg-muted/50 space-y-1.5">
                <p className="text-xs font-medium mb-1.5">Password must have:</p>
            ...
            {/* Features List (only for non-invited users) */}
            {!invitationData && (
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium mb-2">
                    Are you a tenant or maintenance worker?
                  </p>
                  <p className="text-sm text-muted-foreground mb-3">
                    You need an invitation from your property manager to join. Check
                    your email for an invitation link, or ask your property manager
                    to send you one.
                  </p>
                </div>
              </div>
